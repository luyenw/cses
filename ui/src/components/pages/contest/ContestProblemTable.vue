<template>
    ...
    >
      ...
      <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        <tr v-for="problem in data.problems" class="flex odd:bg-white even:bg-gray-50">
          <td class="px-6 py-2 font-weight text-gray-700 w-1/6"></td>
          <td class="px-6 py-2 text-gray-700 w-3/6">
              <router-link :to="{path: `/contests/${data.contest_id}/problems/${problem.id}`}">{{ problem.title }}</router-link>
          </td>
